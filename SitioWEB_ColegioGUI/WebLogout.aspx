...
<body>
    ...
    <div>
        <table class="auto-style1" style="background-color: #44B0B9">
            <tr>
                <td class="auto-style2" rowspan="3">
                    <asp:Image ID="Image1" runat="server" Height="235px" Width="231px" ImageUrl="~/Images/Logout.jpg" />
                </td>
                <td class="auto-style7" colspan="2">
    <span style="text-align: left; background-color: #44B0B9;" class="tituloForm">Cerrar sesión</span></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td class="center">
                    <asp:Button ID="btnFinSesion" runat="server" Height="24px" Text="Salir" Width="166px" CssClass="borderRadius" OnClick="btnFinSesion_Click" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
