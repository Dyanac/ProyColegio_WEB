        ...
        <table class="auto-style1" style="background-color: #44B0B9">
            <tr>
                <td class="auto-style2" rowspan="8">
                    <asp:Image ID="Image1" runat="server" Height="235px" Width="231px" ImageUrl="~/Images/login.jpg" />
                </td>
                <td class="auto-style7" colspan="2">
    <span style="text-align: left; background-color: #44B0B9;" class="tituloForm">BIENVENIDO</span></td>
            </tr>
            <tr>
